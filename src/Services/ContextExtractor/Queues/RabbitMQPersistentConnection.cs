...
namespace FileContextExtractor.Queues
{
    public class RabbitMQPersistentConnection : IRabbitMQPersistentConnection
    {
        ...
        public RabbitMQPersistentConnection(IConnectionFactory connectionFactory, ILogger<EventBusRabbitMQ> logger)
        {
            _logger = logger;
        ...
        public void CreateConsumerChannel()
        {
            ...
            //CHannel 01
            _eventBusRabbitMQ = new EventBusRabbitMQ(this,_logger, "demo-files-queue");
            _eventBusRabbitMQ.CreateConsumerChannel();

            //CHannel 02
            _eventBusRabbitMQ = new EventBusRabbitMQ(this,_logger, "demo-SomeOther-queue");
            _eventBusRabbitMQ.CreateConsumerChannel();
        }
